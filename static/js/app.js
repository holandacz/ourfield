...
(function() {
  var CR, InfoWindow, map, mouseX, mouseY, showBusy, showError, successCallback, userPositionMarker,
  ...
  this.MapView = (function(_super) {
    ...
    MapView.prototype.render = function() {
      ...
      google.maps.event.addListener(map, 'maptypeid_changed', this.onMapTypeChange);
      google.maps.event.addDomListener(controlUI, 'click', function() {
        return _this.addPlace();
      });
      map.controls[google.maps.ControlPosition.TOP_CENTER].push(controlDiv);
      google.maps.event.addListener(map, 'zoom_changed', function() {
        return _this.preferences.set('zoom', map.getZoom());
      });
