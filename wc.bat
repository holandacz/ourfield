...
"C:/Program Files (x86)/nodejs/node"  utils/coffee-script/bin/coffee -wj static/js/app -c static/coffee/models/ static/coffee/collections/ static/coffee/views/ static/coffee/app